...
DEF_IMAGE(10, rgba32f, DENOISE_PREV_INITIAL_DISTANCES);
DEF_IMAGE(11, r32f   , DENOISE_PREV_HISTORY_LENGTH);
DEF_IMAGE(12, rgba32f, DENOISE_PREV_MOMENTS);
DEF_IMAGE(13, r32f,    DENOISE_NEW_HISTORY_LENGTH);
DEF_IMAGE(14, rgba32f, DENOISE_NEW_MOMENTS);
DEF_IMAGE(15, rgba32f, DENOISE_PREV_DIFFUSE);
