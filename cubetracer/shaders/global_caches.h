...
// PATH TRACING CACHES
DEF_IMAGE(12, rgba32f, PT_DIFFUSE);
...
DEF_IMAGE(18, rgba32f, PT_SPECULAR);
DEF_IMAGE(19, rgba32f, DENOISE_PREV_SPECULAR);

DEF_IMAGE(20, rgba32f, BLOCK_COLOR);
DEF_IMAGE(21, rgba32f, BLOCK_MATERIAL);
