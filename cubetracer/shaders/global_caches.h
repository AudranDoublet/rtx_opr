...
DEF_IMAGE(10, r32f   , DENOISE_PREV_HISTORY_LENGTH);
DEF_IMAGE(11, rgba32f, DENOISE_PREV_MOMENTS);
DEF_IMAGE(12, rgba32f, DENOISE_NEW_HISTORY_LENGTH);
DEF_IMAGE(13, rgba32f, DENOISE_NEW_MOMENTS);
